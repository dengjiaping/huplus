...
#define WJColorNavigationBar        [WJUtilityMethod colorWithHexColorString:@"#212121"]
#define WJColorMainRed              [WJUtilityMethod colorWithHexColorString:@"#d41439"]
...
//背景色
#define WJColorViewBg               [WJUtilityMethod colorWithHexColorString:@"#f8f8f8"]
