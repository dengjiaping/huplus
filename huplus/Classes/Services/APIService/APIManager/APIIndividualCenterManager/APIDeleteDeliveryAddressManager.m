//
//  APIDeleteDeliveryAddressManager.m
//  HuPlus
//
...
@implementation APIDeleteDeliveryAddressManager
...
{
    return self.userId.length > 0 && self.receiveId.length > 0;
}
