...
@implementation APIMyCouponManager
- (instancetype)init
{
    self = [super init];
    if (self) {
...
- (NSDictionary *)paramsForApi:(APIBaseManager *)manager
{
    ...
    return @{@"user_id" :self.userId,
             @"coupon_status" :NumberToString(self.couponCurrentStatus),
