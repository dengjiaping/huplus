//
//  APIAddDeliveryAddressManager.m
//  HuPlus
//
...
@implementation APIAddDeliveryAddressManager
- (instancetype)init
{
    self = [super init];
    if (self) {
...
- (NSDictionary *)paramsForApi:(APIBaseManager *)manager
{
    return @{@"user_id" :self.userId?:@"",
             ...
             @"is_default" :NumberToString(self.isDefault),
             @"operation_type" :NumberToString(self.operationType)
             };
