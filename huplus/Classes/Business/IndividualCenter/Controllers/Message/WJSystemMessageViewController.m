...
@interface WJSystemMessageViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
{
//    WJMessageDetailViewController *messageDetailVC = [[WJMessageDetailViewController alloc] init];
...
-(APIMessageListManager *)messageListManager
{
    ...
    _messageListManager.messageType = @"1";
