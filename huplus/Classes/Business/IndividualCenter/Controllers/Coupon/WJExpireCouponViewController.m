//
//  WJExpireCouponViewController.m
//  HuPlus
//
...
@interface WJExpireCouponViewController ()<UITableViewDelegate,UITableViewDataSource,APIManagerCallBackDelegate>
{
...
@implementation WJExpireCouponViewController
...
-(APIMyCouponManager *)myCouponManager
{
    ...
    _myCouponManager.couponCurrentStatus = CouponStatusExpired;
