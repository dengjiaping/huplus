...
@interface WJMyAllOrderController ()<UITableViewDelegate,UITableViewDataSource,APIManagerCallBackDelegate>
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.checkLogisticseBlock = ^ {
        __strong typeof(self) strongSelf = weakSelf;
        
        //查看物流
        [strongSelf.delegate performSelector:@selector(checkLogisticseWithOrder:) withObject:self.orderArray[indexPath.section]];

    };
    
    cell.ConfirmReceiveBlock = ^ {
        __strong typeof(self) strongSelf = weakSelf;
        
        //确认收货
        [strongSelf.delegate performSelector:@selector(ConfirmReceiveWithOrder:) withObject:self.orderArray[indexPath.section]];
...
//        orderModel.shopId = ;
    ...
    cell.cancelOrderBlock = ^ {
        ...
        //取消订单
        [strongSelf.delegate performSelector:@selector(cancelOrderWithOrder:) withObject:self.orderArray[indexPath.section]];
    };
...
-(APIOrderListManager *)orderListManager
{
    ...
    _orderListManager.orderStatus = OrderStatusAll;
