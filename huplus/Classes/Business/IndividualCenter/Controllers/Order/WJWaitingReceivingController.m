//
//  WJWaitingReceivingController.m
//  HuPlus
//
...
@interface WJWaitingReceivingController ()<UITableViewDelegate,UITableViewDataSource,APIManagerCallBackDelegate>
{
...
@implementation WJWaitingReceivingController
...
-(APIOrderListManager *)orderListManager
{
    ...
    _orderListManager.orderStatus = OrderStatusWaitReceive;
