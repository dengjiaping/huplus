//
//  WJMyAllCreditsViewController.m
//  HuPlus
//
...
@interface WJMyAllCreditsViewController ()<UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate>
{
...
@implementation WJMyAllCreditsViewController
