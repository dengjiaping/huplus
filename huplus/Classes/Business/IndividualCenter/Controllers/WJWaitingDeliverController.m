...
@interface WJWaitingDeliverController ()<UITableViewDelegate,UITableViewDataSource,APIManagerCallBackDelegate>
{
...
-(APIOrderListManager *)orderListManager
{
    ...
    _orderListManager.orderStatus = OrderStatusWaitDeliver;
